    ...
    <form method="post" action="users_update.php">
        <div class="jumbotron">
            <fieldset>
                ...
                <label>管理FLG：
                    一般（学生）<input type="radio" name="kanri_flg" value="1">
                    管理者（先生）<input type="radio" name="kanri_flg" value="0">
                </label>
                <br>
                <label>在学FLG：
                    在学<input type="radio" name="life_flg" value="1">
                    卒業<input type="radio" name="life_flg" value="0">
                </label>
